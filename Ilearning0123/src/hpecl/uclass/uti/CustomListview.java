...
* Version：1.1
* Date：2015/07/11
* Description：This java file is to realize drop down refresh.
* Modify history：
* 郭靖东,create file,2015/07/11
*/
...
public class CustomListview extends ListView implements OnScrollListener {
	...
	private final static int RELEASE_TO_REFRESH = 0;
	  ...
	  //        setCacheColorHint(android.R.color.black);
	          ...
	          mHeadView = (LinearLayout) mInflater.inflate(R.layout.headerview, null);
	          mArrowImageView = (ImageView) mHeadView.findViewById(R.id.head_arrowImageView);
//	          mArrowImageView.setMinimumWidth(70);
	          mArrowImageView.setMinimumHeight(10);
