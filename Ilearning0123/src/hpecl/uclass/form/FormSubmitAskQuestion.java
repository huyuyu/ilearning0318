...
* filename：FormSubmitAskQuestion.java
* Author：郭靖东
* Version：1.1
* Date：2015/09/07
* Description：This java file is used for submitting ask and question form to website.
* Modify history：
* 郭靖东,create file,2015/09/07
*/
...
public class FormSubmitAskQuestion {
			...
			URL url = new URL(sUrl);
				...
				try {
					...
					params.append("enews").append("=").append("MAddInfo").append("&")			        
		              .append("classid").append("=").append(Constant.QUESTIONID).append("&")			              			             
