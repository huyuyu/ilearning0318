...
* filename：FormSubmitQuestion.java
* Author：郭靖东
* Version：1.1
* Date：2015/08/21
* Description：This java file is used for submitting question form to website.
* Modify history：
...
public class FormSubmitQuestion {
			...
			URL url = new URL(sUrl);
				...
				try {
					...
					if(replyID.equals("0")){ params.append("username").append("=").append(username).append("&")
			              ...
			              .append("classid").append("=").append("104").append("&")
