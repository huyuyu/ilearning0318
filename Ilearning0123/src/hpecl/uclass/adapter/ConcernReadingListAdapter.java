...
public class ConcernReadingListAdapter extends BaseAdapter {

	private List<Article> mList;
	private LayoutInflater mLI = null;

	public ConcernReadingListAdapter(Context myAsyncTask, List<Article> mList) {
		super();
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		vh.tv1.setText(mList.get(arg0).getTitle());
