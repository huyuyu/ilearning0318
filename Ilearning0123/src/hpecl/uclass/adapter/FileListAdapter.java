...
* filename：FileListAdapter.java
* Author：郭靖东
* Version：1.1
* Date：2015/08/15
* Description：This adapter is used for showing the content of files in SDcard by ListView, not used in the project now.
* Modify history：
* 郭靖东,create file,2015/08/15
*/
