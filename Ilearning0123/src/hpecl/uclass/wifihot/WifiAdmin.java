package hpecl.uclass.wifihot;

import hpecl.uclass.ilearning.FileTransfer;
import hpecl.uclass.ilearning.WifiHotActivity;
...
//        Log.i("guo ", "1226  " + mWifiInfo.getIpAddress());  
    }  
    ...
    public void addNetwork(WifiConfiguration wcg) {  
        ...
        progressDialog = ProgressDialog.show(mContext, "请稍等...", "正在加入......", true);
...
//                Log.d(TAG, " intent is " + WifiManager.RSSI_CHANGED_ACTION);  
                ...
                Log.i("guo ", "1226   "+getSSID);
                Log.i("guo ", "1226   "+mWifiInfo.toString());
//                Log.i("guo ", "1226   "+mWifiInfo.getIpAddress());
                Log.i("guo ", "1226   "+intToIp(mWifiInfo.getIpAddress()));

//              wifi已经连接并且ssid要正确，之后跳转
                if (isWifiContected(mContext) == WIFI_CONNECTED && getSSID.contains(rssid)) {  
//                	Log.i("guo ", "1226   "+intToIp(mWifiInfo.getIpAddress()));
                	Intent intent1 = new Intent(mContext,FileTransfer.class);
                	intent1.putExtra("info", "连接成功！");
                	intent1.putExtra("name", WifiHotActivity.ssid);
                	...
                	Log.i("guo ", "1226   "+intToIp(mWifiInfo.getIpAddress()));
                	Toast.makeText(mContext, "并没有连上，请再次点击你的小伙伴", Toast.LENGTH_SHORT).show();
                    stopTimer();  
//                    closeWifi();  
...
//        Log.v(TAG, "isConnectedOrConnecting = " + mobileInfo.isConnectedOrConnecting()); 
